...
$(function () {	
	...
	if('${sdYn}' == 'Y')
		var pw = window.open('/securityDay/popSecurityDay.do?reqCode=1','securityDay','width=980, height=782,scrollbars=yes, resizable=yes, menubar=no, status=no, toolbar=no');
...
<!-- S : contents -->
	<div id="maincnt" style="width:100%;">
	<!-- S : left contents -->
	<div id="maincnt_L">
    	<!-- S : socre -->
        <div class="block1">
        	<li class="blockcell1"><img src="/img/icon_user.png" /></li>
    	...
    	<div class="block_score">
            ...
            <div style='border:0px solid red;margin-top:5px;' class="score_cell3"><img src="/img/icon_notice_top.png" /> 현재 보안등급 <span style="color:${totalUserInfo.scorestat_color};">${totalUserInfo.scorestat_name }</span>단계입니다.</div>            
        </div>
        <!-- E : socre -->
    ...
    <div id="maincnt_R">
    	<!-- S : 2015-12-21 수정 영역 --->
    	<div class="index_block1" style="width:100%;overflow-x:auto;">
    	<div style="min-width:${totalUserInfo.graph_panel_width};">
        ...
        <div class="index_block3cell" style="width:100%;">
            <li class="cell1 result_title"><img src="/img/icon_index.png" /> 지수점수 > PC보안</li>
            <li class="cell2 result_status">전체 정책 <span class="txcell1">양호0개</span> <span class="txcell2">취약0개</span><!--  <span><a href="#" class="txcell3"><img src="/img/icon_excel.png" /> EXCEL</a></span> --></li>
        </div>
        <!-- E : 테이블 스크롤-->
		<div class="index_tbl list_contents_body" style="width:100%;min-height:200px;overflow-y:auto;height:400px;">     
           <%-- <table class="scroll_list" id="table1" style="width:100%;">
                <colgroup>
                    <col style="width:22%;" />
                    <col style="width:13%;" />
                    <col style="width:13%;" />
                ...
                <tbody>
                    <tr>
                        <td class="cell1">백신최신보안  패치여부</td>
                        <td class="cell1">10</td>
                        <td class="cell1">80점</td>
                        <td class="cell1"></td>
                        <td class="cell1"><a href="#" class="btn_details">상세보기</a></td>
                    </tr>
                    <tr>
                        <td class="cell2">PC지키미 취약항목 건수</td>
                        <td class="cell2">10</td>
                        <td class="cell2">80점</td>
                        <td class="cell2"><span class="scondition2">취약</span></td>
                        <td class="cell1"><a href="#" class="btn_details">상세보기</a></td>
                    </tr>
                    <tr>
                        <td class="cell1">엑티브X 취약항목건수</td>
                        <td class="cell1">10</td>
                        <td class="cell1">80점</td>
                        <td class="cell1"><span class="scondition1">양호</span></td>
                        <td class="cell1"><a href="#" class="btn_details">상세보기</a></td>
                    </tr>
                    <tr>
                        <td class="cell2">백신설치 및 실행여부</td>
                        <td class="cell2">10</td>
                        <td class="cell2">80점</td>
                        <td class="cell2"><span class="scondition1">양호</span></td>
                        <td class="cell1"><a href="#" class="btn_details">상세보기</a></td>
                    </tr>
                    <tr>
                        <td class="cell1">로그인/패스워드 안전성여부</td>
                        <td class="cell1">10</td>
                        <td class="cell1">80점</td>
                        <td class="cell1"><span class="scondition2">취약</span></td>
                        <td class="cell1"><a href="#" class="btn_details">상세보기</a></td>
                    </tr>
                    <tr>
                        <td class="cell2">PC지키미 실패건수</td>
                        <td class="cell2">10</td>
                        <td class="cell2">80점</td>
                        <td class="cell2"><span class="scondition2">취약</span></td>
                        <td class="cell1"><a href="#" class="btn_details">상세보기</a></td>
        ...
        <div class="block_warp" style="width:100%;border:0px solid red;box-sizing : border-box;">
            <div class="notice_block" style="width:50%;border:0px solid red;box-sizing : border-box;">
            <!-- S : notice -->
            <h4>Notice</h4>
                <div class="mnoticeTT" style="width:100%;"><span style="width:80%;"><img src="/img/icon_notice.png" /> Notice </span><a href="/man/noticelist.do" style="width:20%;">+ more</a></div>
                <ul class="mnotice" style="width:100%;padding-left:0px;">
                <c:forEach var="result" items="${noticeList}" varStatus="status">
		        	<li style="width:100%;border:0px solid red;"><a style='cursor:pointer;width:75%;border:0px solid red;padding-left:0px;' class='dash_notice_view' nseq='${result.sq_no}'>${fn:substring(result.title, 0, 35)}<c:if test="${fn:length(result.title) > 35}" >...</c:if></a> <span style="width:25%;border:0px solid red;text-align:center;">${result.upd_date}</span></li>
		        </c:forEach>
                </ul>            
            </div>
            <!-- E : notice-->
       
        	<div class="qustion_block" style="width:50%;border:0px solid red;box-sizing:border-box;margin-left:0px;">
            <!-- S : qustions -->
            <h4>Questions</h4>
                <div class="mnoticeTT" style="width:100%;"><span style="width:80%;"><img src="/img/icon_question.png" /> Frequently Questions </span><a href="/man/faqlist.do" style="width:20%;">+ more</a></div>
                <ul class="mnotice" style="width:100%;padding-left:0px;">
                <c:forEach var="result" items="${faqList}" varStatus="status">
	           		<li style="width:100%;"><a style='cursor:pointer;width:75%;border:0px solid red;padding-left:0px;' class='dash_faq_view' nseq='${result.sq_no}'>${fn:substring(result.title, 0, 35)}<c:if test="${fn:length(result.title) > 35}" >...</c:if></a> <span style="width:25%;border:0px solid red;text-align:center;">${result.upd_date}</span></li>
	            </c:forEach>
                </ul>            
        	</div>
        	 <!-- E : qustions -->
