...
<div id="container">
    ...
    <div class="snb">
        ...
        <c:forEach var="result" items="${policyScoreList}" varStatus="status">
        	<c:if test="${result.score != '-999' && result.count != '-'}" >
        		<div style="cursor:pointer;" class="graph4_date5 diag_majr" search_date="${result.search_rgdt_date }" org_code="${result.org_code }" diagcode="${result.diag_majr_code}" diagDesc="${result.diag_desc}" buseoindc="${result.buseo_indc}" is_sub_org="${result.is_sub_org }">
    ...
    <div class="aside">
		...
		<c:if test="${sdYn eq 'Y'}">
			<li class="cell1" onclick="$.sdPopup();"   style="cursor: pointer;"><img src="/img/icon_right_4.png" />Security<br/>Day</li>
		</c:if>
