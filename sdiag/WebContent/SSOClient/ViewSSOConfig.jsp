<%@ page import="nets.websso.ssoclient.authcheck.CryptEncType"%>
                                                ...
                                                <td valign="top">
                                                    <table align="left" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="1" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td-value">&nbsp;&nbsp;<%=SSOConfig.LogoutOption()%></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="td-property" nowrap="true">&nbsp;SSO 도메인 인증 암호화 키</td>
                                                            <td class="td-value">&nbsp;&nbsp;<%=SSOConfig.SSODomainTokenEncKey()%></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="td-property" nowrap="true">&nbsp;SSO 도메인 인증 암호화 방식</td>
                                                            <td class="td-value">&nbsp;&nbsp;<%=SSOConfig.SSODomainEncType()%></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="td-property" nowrap="true">&nbsp;SSO 도메인 쿠키 암호화 </td>
                                                            <td class="td-value">&nbsp;&nbsp;<%=SSOConfig.SSODomainCookieEncKey()%></td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table bgcolor="#E0E0E0" border="0" cellpadding="0" cellspacing="1" width="100%">
                                                                                ...
                                                                                <%
                                                                                    for (int i = 0; i < SSOConfig.SSODomainCookieInfos().size(); i++) {
                                                                                        CookieInfo cookie = (CookieInfo)SSOConfig.SSODomainCookieInfos().get(i);
                                                                                %>
                                                                                <tr>
                                                                                    <td><%=cookie.Name()%></td>
                                                                                    <td><%=cookie.IsEnc()%></td>
