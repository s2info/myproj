...
public class SdSearchVO{
	...
	public String getqFormMod() {
		return qFormMod;
	}

	public void setqFormMod(String qFormMod) {
		this.qFormMod = qFormMod;
	}
	...
	public int getS_clGroupNo() {
		return s_clGroupNo;
	}

	public void setS_clGroupNo(int s_clGroupNo) {
		this.s_clGroupNo = s_clGroupNo;
	}
