...
$(function () {		
	...
	$('#begindate, #enddate').datepicker({
	 ...
	 $('.btn_export_excel').click(function(){
		    ...
		    params[3] = JSON.stringify({"inputname": 'searchType', "inputvalue": 'O'});
	...
	function searchList(page)
	{
	   ...
	   $.ajax({
			url : '/stat/getstatistpolicyfactInfoorgdata.do',
			data : data,
			type : 'POST',
			dataType : 'json',
			error : function(jqXHR, textStatus, errorThrown) {
...
<div id="cnt">
    ...
    <form:form commandName="searchVO" name="listForm" method="post">
    	<div>
    		...
    		<a class="btn_type1"><span>조직별 통계</span></a>
    	</div>
    	<div class="pd10"></div>
    	<div class="subTT"><span>조직별 통계</span></div>
    	<!-- S :search -->
