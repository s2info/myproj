...
$(function () {	
	...
	$(".btn_view").click(function(){
		...
		document.listForm.action = "<c:url value='/exception/exceptionEmpNoForm.do'/>";
		document.listForm.submit();
	});	
	
	$(".btn_goForm").click(function(){
		$("#formMod").val("I");
	...
	$('.btn_delete').click(function(){
		...
		if(checked_length <= 0){
			...
			if(secPolIdList.length > 0){
				$.ajax({
					url : '/exception/exceptionEmpNoDelete.do',
					data : data,
					type : 'POST',
					dataType : 'json',
	...
	function goPage() {
	    ...
	    document.listForm.action = "<c:url value='/exception/exceptionEmpNoList.do'/>";
        ...
        <!-- E :search -->
    	 <div class="sch_view">
            ...
            <div class="btn_borderWrite">
            	...
            	<a class="btn_black btn_goForm"><span>등록</span></a>
            </div>
        </div>
