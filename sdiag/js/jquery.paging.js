...
(function($){
	...
	var a=/a/i,defs={
	    item: 'li',
	    next: '<li class="padd2"><a style="cursor:pointer;"><img src="/img/btn_next1.jpg" alt="next" /></a></li>',
	    prev: '<li class="padd1"><a style="cursor:pointer;"><img src="/img/btn_prve1.jpg" alt="perv" /></a></li>',
	    format: '<a style="cursor:pointer;">{0}</a>',
	    itemClass: 'num',
	    sideClass: '',
	    itemCurrent: '<li class="sel">{0}</li>',
	    length: 10,
	    max: 1,
	    current: 1,
	    append: false,
	    href: '',
		event: true,
		first: '<li class="padd1"><a style="cursor:pointer;"><img src="/img/btn_prve2.jpg" alt="first" /></a></li>',
		last: '<li class="padd2"><a style="cursor:pointer;"><img src="/img/btn_next2.jpg" alt="last" /></a></li>'
	},format=function(str){
		var arg=arguments;
		...
		$(item).html(format(str,page,op.length,op.start,op.end,op.start-1,op.end+1,op.max));
		//item.appendChild(document.createElement(format(str,page,op.length,op.start,op.end,op.start-1,op.end+1,op.max)));
